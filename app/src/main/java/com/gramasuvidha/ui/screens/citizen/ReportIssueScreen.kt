...
fun ReportIssueScreen(
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(stringResource(id = R.string.report_issue)) },
                navigationIcon = {
        ...
        Column(
            ...
            Text(text = "Describe the issue you encountered with this project:", style = MaterialTheme.typography.bodyLarge)
            ...
            CustomButton(
                ...
                onClick = {
                    val issue = IssueEntity(
                        ...
                        issueText = issueText,
                        status = "Pending",
                        reportedBy = "Citizen User" // In real app, fetch from User session
                    )
                    viewModel.submitIssue(issue)
